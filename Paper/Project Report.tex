...
\begin{document}
    ...
    Examining the more low-level decisions of navigation, Huang et al. (2019) trained an agent using Deterministic Deep Policy Gradient to effectively control driving action decisions such as steering, accelerating and braking, to follow some prescribed path [8]. This lower-level scope of actions may be used in conjunction with navigation-oriented policies to develop an end-to-end, real world autonomous agent. 
	...
	[15] R. S. Sutton and A. G. Barto. Reinforcement Learning (2nd ed.). MIT Press. pp. 121-133. 2018.
